...
CAFL es un framework/plataforma operativo sobre OpenCode para desarrollar soluciones empresariales Odoo con asistencia de IA durante el ciclo de vida de desarrollo.
...
En caso de conflicto, `project-truth/` tiene prioridad sobre cualquier documento raiz o instruccion operativa. No se deben duplicar decisiones fuera de `project-truth/` ni crear documentos paralelos que compitan con esa fuente.
