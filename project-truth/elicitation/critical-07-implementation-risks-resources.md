...
- [draft] Definir setup operativo candidato, viabilidad, recursos, riesgos, secuencia y recortes para implementar el modelo mixto aprobado, sin reabrir OpenCode como runtime principal ni adelantar implementacion.
...
- [open-question] Operacion local/global y separacion source-vs-runtime.
...
- [accepted] No crear agentes ejecutables, commands, scripts, permisos ni config runtime.
...
- [draft] Setup operativo candidato para OpenCode agents, commands, SDK/server/scripts, permissions, config, skills, rules/AGENTS.md y operacion local/global.
- [draft] Plan candidato de entorno Odoo real, instalacion/carga/actualizacion, tests aplicables y evidencia ejecutable.
- [draft] Lista de recortes, alcance RAG V1 o diferimiento, modulo piloto exacto y secuencia candidata compatible con 2 meses.
...
- [draft] Setup operativo cubre agents, commands, SDK/server/scripts, permissions, config, skills, rules/AGENTS.md, operacion local/global y source-vs-runtime.
